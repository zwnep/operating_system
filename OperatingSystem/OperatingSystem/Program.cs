...
namespace OperatingSystem
{
    class Program
    {
        ...
        static void yaz(object indis)
        {
            ...
            {
                Console.WriteLine("y"); //Kritik alan

                lock (obj) ; //Thread Safe kod yazılacapı zaman yazılır.

                sayi++;

                dizi[(int)indis]++; //dizi değişkenin 19. indisini 10.000 arttırıyor.
            }
        }
        ...
        private static void Worker(object num) //Semaphore
        {
            ...
            _pool.WaitOne(); //Kritik alana girerken Semaphore'un WaitOne fonk. kullanılır.
        ...
        static void Main(string[] args)
        {
            ...
            */
            ...
            //foreground threadler backgrounda dönüştürüldüğü zaman ikisi arasındaki tek fark background un otomatik olarak kapatması.
            //her bir thread 1 defa kullanılır.
